...
export default function Quiz() {
  ...
  return (
    <div className='w-full h-screen flex justify-center itmes-center bg-slate-500'>
...
const Box = ({current,next}) =>{
    ...
    return (
        <div className='w-[50%] h-[40%]  mt-20 border shadow-lg rounded-md overflow-hidden bg-slate-300 '>
            ...
            <div className='flex justify-between'>
                <div className='cursor-pointer h-[30px] px-3 mx-3 my-10 bg-cyan-500 text-white text-2xl rounded-lg' onClick={() => setAns("")}>Reset</div>
                <div className='cursor-pointer h-[30px] px-3 mx-3 my-10 bg-purple-600 text-white text-2xl rounded-lg' onClick={saveHandler}>Save & Next</div>
                <div className='cursor-pointer h-[30px] px-3 mx-3 my-10 bg-green-600	 text-white text-2xl rounded-lg'onClick={() => setExit(true)}>Exit</div>
            </div>
        </div>
    )
}
